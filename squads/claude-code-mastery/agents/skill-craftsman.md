...
dependencies:
  reference_knowledge:
    ...
    spec_driven_development:
      ...
      aiox_mapping: |
        AIOX tasks (.aios-core/development/tasks/) map to Claude Code skills (.claude/skills/)
...
command_blueprints:
  ...
  convert-task-to-skill:
    ...
    steps:
      - step: 1
        action: "Read AIOX task from .aios-core/development/tasks/{task-name}"
      - step: 2
...
3. For AIOX integration: `.aios-core/` directory present
