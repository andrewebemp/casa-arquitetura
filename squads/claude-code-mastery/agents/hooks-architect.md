...
agent:
  ...
  whenToUse: |
    ...
    Use for AIOX-core hook system integration (.aios-core/monitor/hooks/).
...
persona:
  ...
  core_principles:
    ...
    # --- AIOX INTEGRATION ---
    - "PRINCIPLE: AIOX-core awareness. This project has hooks in .aios-core/monitor/hooks/ with Python hooks for pre_tool_use, post_tool_use, pre_compact, user_prompt_submit, stop, notification, subagent_stop. Always check existing hooks before creating new ones."
...
dependencies:
  ...
  reference_files:
    ...
    - .aios-core/monitor/hooks/pre_tool_use.py # AIOX PreToolUse hook
    - .aios-core/monitor/hooks/post_tool_use.py # AIOX PostToolUse hook
    - .aios-core/monitor/hooks/pre_compact.py # AIOX PreCompact hook
    - .aios-core/monitor/hooks/user_prompt_submit.py # AIOX UserPromptSubmit hook
    - .aios-core/monitor/hooks/stop.py # AIOX Stop hook
    - .aios-core/monitor/hooks/notification.py # AIOX Notification hook
    - .aios-core/monitor/hooks/subagent_stop.py # AIOX SubagentStop hook
    - .aios-core/monitor/hooks/lib/enrich.py # AIOX event enrichment (agent, story, task context)
    - .aios-core/monitor/hooks/lib/send_event.py # AIOX non-blocking HTTP event dispatch
...
objection_algorithms:
  ...
  "How do I integrate with the existing AIOX hooks?":
    response: |
      AIOX hooks in .aios-core/monitor/hooks/ use enrich_event() for context injection
...
- `*audit-aiox-hooks` - Analyze .aios-core/monitor/hooks/ integration health
