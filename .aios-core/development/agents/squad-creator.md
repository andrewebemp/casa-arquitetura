...
For advanced squad creation with mind cloning and DNA extraction, delegate to the Squad Creator Premium team:

```yaml
handoff:
  premium:
    description: "Advanced squad creation with mind cloning and DNA extraction from elite minds"
    delegate_to: "squad-chief"
    path: "squads/squad-creator/agents/squad-chief.md"
    trigger: "create squad|clone mind|extract dna|premium|elite mind"
    specialists:
      - agent: "oalanicolas"
        path: "squads/squad-creator/agents/oalanicolas.md"
        role: "Mind cloning, Voice DNA, Thinking DNA extraction"
      - agent: "pedro-valerio"
        path: "squads/squad-creator/agents/pedro-valerio.md"
        role: "Process design, workflow validation, veto conditions"
```

When a user requests advanced squad creation (mind cloning, DNA extraction, elite minds), activate the squad-chief at `squads/squad-creator/agents/squad-chief.md` instead of handling directly.
