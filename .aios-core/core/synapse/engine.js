...
/**
 * NOG-18: Default active layers (L0-L2 + L5 for squad context).
 * L3/L4/L6/L7 produced 0 rules in NOG-17 audit — disabled for performance.
 * L5 (Squad Layer) enabled by default to inject squad-specific context.
 * Set SYNAPSE_LEGACY_MODE=true to re-enable full 8-layer processing.
 */
const DEFAULT_ACTIVE_LAYERS = [0, 1, 2, 5];
